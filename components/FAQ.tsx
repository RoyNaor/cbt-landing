...
const faqs = [
  ...
  { 
    ...
    a: "טיפול CBT (טיפול קוגניטיבי-התנהגותי) הוא טיפול ממוקד המסייע לזהות ולשנות דפוסי מחשבה והרגלי התנהגות שמקשים על האדם, ולבנות דרכי חשיבה והתנהגויות חדשות, חיוביות ומסתגלות להתמודדות יעילה יותר עם אתגרים. הטיפול מתמקד בהווה ובפתרון בעיות ומבוסס על ההבנה ,שהפרשנות שלנו למציאות משפיעה על רגשותינו ותגובותינו יותר מהסיטואציה עצמה. " 
  },
  { 
    q: "איך מטפלים בפועל?", 
    a: "בתהליך הנעשה בגישה הקוגניטיבית התנהגותית   מזהים דפוסי חשיבה שליליים, מגדירים מטרות, ומפתחים דרכי חשיבה והתנהגויות חדשות ומועילות יותר. המטופל משתף פעולה באופן פעיל ומקבל משימות מעשיות, במטרה להביא לשינוי משמעותי ומהיר." 
  },
  { 
