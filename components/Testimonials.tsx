...
הדבר המיוחד שהופך את בית הספר שלנו לכזה מיוחד הוא האנשים המרכיבים אותו.
לך, שרון, יש את היכולת להביט אל תוך עולמם הפנימי של התלמידים. 
יכולת מבורכת שנובעת ממסירות, אמפתיה ורצון לקדם אידיאל אמיתי של חינוך. יתרה מכך היא גם תובענית ולכן קיימת רק אצל אלו שמשקיעים מכל הלב.
תודה לך שהיית שם בשבילי והזכרת לי כמה חשוב זה לדאוג לעצמי ולקרובים לי.
`,
  },
  {
    text: `לשרון,
...
...המבחנים עברו מצוין (לשון 95, מתמטיקה 97, אנגלית 94) והיא הייתה רגועה...
...
תודה רבה.`,
  ...
  {
    text: `שרון,
תודה על מי ועל מה שהיית בשבילי במסע.
תודה על האוזן הקשבת, ההבנה, ההכלה, האהבה והאכפתיות. תודה על שהיה לך אכפת ממני וממצבי הבריאותי, תודה על החיוך, הפרגון, החיבוק והמילים הטובות שחיממו את הלב. שום דבר מזה לא מובן מאליו.
באהבה והערכה ענקית
`,
  },
];
